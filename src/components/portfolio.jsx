      ...
      <section id="work" className="portfolio-mf sect-pt4 route">
        <div className="container">
          ...
          <div className="row">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h4 className="w-title">Symptom Tracker with Built-In Hearing Test</h4>
                        <div className="w-more">
                          <span className="w-ctegory">
                            ReactJS | Redux | Rails | PostgreSQL
                            <br/>
                          </span>
                        </div>
                      </div>
            ...
            <div className="col-md-4">
              <div className="work-box">
                <a href={stock7} data-lightbox="gallery-aguadeluz">
                  <div className="work-img">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Mood Journal</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <a href={stock11} data-lightbox="gallery-todo">
                  <div className="work-img">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">COVID-19 Trivia App</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                          ReactJS | Ruby on Rails | PostgreSQL <br/>
                          </span>
